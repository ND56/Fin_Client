...
var notification = __webpack_require__(40);
// used to store information for DOM manipulation, etc.
var store = __webpack_require__(10);
var templateGoogleResponse = __webpack_require__(42);
var templateSpotifyResponse = __webpack_require__(58);
...
var logInSuccess = function logInSuccess(apiResponse) {
  // clear form
...
var buildProfileSuccess = function buildProfileSuccess(apiResponse) {
...
var buildProfileFailure = function buildProfileFailure(error) {
  // store attempted username
...
var requestEditProfileModal = function requestEditProfileModal() {
...
var editProfileSuccess = function editProfileSuccess(apiResponse) {
  // update store
...
var editProfileFailure = function editProfileFailure(error) {
  // store attempted username
...
var displayMessage = function displayMessage(message, speaker) {
  ...
  if (speaker === 'user') {
    ...
    var delayedMessage = function delayedMessage() {
    ...
    var appendMessage = function appendMessage() {
      $('#typing').remove();
...
var displaySpotify = function displaySpotify(results) {
  var element = document.getElementById('messagesWrapper');
  // delay Fin's message to give appearance Fin is "typing"
  var delayedMessage = function delayedMessage() {
    $('#messagesUL').append('<li id="typing" class="typing"><span>Fin is typing...</li>');
  ...
  var appendMessage = function appendMessage() {
    ...
    if (results.items === undefined || results.items.length === 0) {
      ...
      // scroll to bottom of div
      element.scrollTop = element.scrollHeight;
    } else if (results.items.length === 3) {
      // if there are 3 results
      var spotifyHTML = templateSpotifyResponse({ results: results.items });
      ...
      // scroll to bottom of div
      element.scrollTop = element.scrollHeight;
    } else if (results.items.length === 2) {
      // two results
      var _spotifyHTML = templateSpotifyResponse({ results: results.items });
      // append search results
      ...
      // one result
      var _spotifyHTML2 = templateSpotifyResponse({ results: results.items });
      // append search results
...
var googleSearchSuccess = function googleSearchSuccess(apiResponse) {
  var element = document.getElementById('messagesWrapper');
  // delay Fin's message to give appearance Fin is "typing"
  var delayedMessage = function delayedMessage() {
    $('#messagesUL').append('<li id="typing" class="typing"><span>Fin is typing...</li>');
  ...
  var appendMessage = function appendMessage() {
    ...
    if (apiResponse.items === undefined) {
      ...
      var googleHTML = templateGoogleResponse({ results: apiResponse.items });
      // append search results
...
var googleSearchFailure = function googleSearchFailure(apiResponse) {
  notification.tempToast('error', 'Google Search Failed', 'Try re-phrasing your search query!', 'red', 'black', 'red', 8000);
};

var displayGreeting = function displayGreeting(name) {
  var element = document.getElementById('messagesWrapper');
  // delay Fin's message to give appearance Fin is "typing"
  var delayedMessage = function delayedMessage() {
    $('#messagesUL').append('<li id="typing" class="typing"><span>Fin is typing...</li>');
...
var rejectUserInput = function rejectUserInput() {
  // clear register form
  $('#register-form').each(function () {
    this.reset();
  });
...
module.exports = {
  ...
  requestPwdModal: requestPwdModal,
  changePasswordSuccess: changePasswordSuccess,
  changePasswordFailure: changePasswordFailure,
  buildProfileSuccess: buildProfileSuccess,
  buildProfileFailure: buildProfileFailure,
  requestEditProfileModal: requestEditProfileModal,
  ...
  googleSearchSuccess: googleSearchSuccess,
  googleSearchFailure: googleSearchFailure,
...
var apiUrl = __webpack_require__(16);
...
var bootstrap = __webpack_require__(83);
...
var onToggleRegister = function onToggleRegister(event) {
...
var onRegister = function onRegister(event) {
  event.preventDefault();
  var registerData = getFormFields(event.target);
  var attemptedEmail = $('#inputEmail2').val();
  if (!attemptedEmail.match(/[<>]/)) {
    api.registerUser(registerData).then(ui.registerSuccess).catch(ui.registerFailure);
  } else {
    ui.rejectUserInput();
  }
};
...
var onLogIn = function onLogIn(event) {
  event.preventDefault();
  var logInData = getFormFields(event.target);
  var attemptedEmail = $('#inputEmail1').val();
  if (!attemptedEmail.match(/[<>]/)) {
    api.logIn(logInData).then(function (apiResponse) {
    ...
    // proceed with log in
    .then(ui.logInSuccess).catch(ui.logInFailure);
  } else {
    ui.rejectUserInput();
  }
};

var onBuildProfile = function onBuildProfile(event) {
  event.preventDefault();
  var profileData = getFormFields(event.target);
  var attemptedUsername = $('#inputUsername1').val();
  if (!attemptedUsername.match(/[<>]/)) {
    api.createProfile(profileData).then(ui.buildProfileSuccess).catch(ui.buildProfileFailure);
  } else {
    ui.rejectUserInput();
  }
};
...
var onChangePwd = function onChangePwd(event) {
  event.preventDefault();
  var changePwdData = getFormFields(event.target);
  api.changePwd(changePwdData).then(ui.changePasswordSuccess).catch(ui.changePasswordFailure);
};

var onDeleteProfile = function onDeleteProfile(event) {
  event.preventDefault();
  api.deleteProfile().then(api.logOut).then(ui.deleteProfileSuccess).catch(ui.deleteProfileFailure);
};

var onEditProfile = function onEditProfile(event) {
  event.preventDefault();
  var editProfileData = getFormFields(event.target);
  var attemptedProfile = $('#inputUsername20').val();
  if (!attemptedProfile.match(/[<>]/)) {
    api.editProfile(editProfileData).then(ui.editProfileSuccess).catch(ui.editProfileFailure);
  } else {
    ui.rejectUserInput();
  }
};

var submitMessage = function submitMessage(event, socket) {
  event.preventDefault();
...
var socketReceive = function socketReceive(message) {
...
var googleAction = function googleAction(query) {
  // console.log('google: ', query)
  api.googleSearch(query).then(ui.googleSearchSuccess).catch(ui.googleSearchFailure);
};

var onGreeting = function onGreeting(name) {
  ui.displayGreeting(name);
};

var onSkillsRequest = function onSkillsRequest() {
  ui.displaySkills();
};

var onSpotifyRequest = function onSpotifyRequest(results) {
  // console.log(results)
...
module.exports = {
  ...
  onSkillsRequest: onSkillsRequest,
  onSpotifyRequest: onSpotifyRequest
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var addNestedValue = __webpack_require__(38);
...
var registerUser = function registerUser(registerData) {
  return $.ajax({
    url: apiUrl + '/sign-up',
    method: 'POST',
    headers: {
...
var findProfile = function findProfile(data) {
  return $.ajax({
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div class=\"row google-row\">\n    <div class=\"col-xs-3 search-image\" data-id=\"image-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.cacheId : stack1), depth0))
    + "\"></div>\n    <div class=\"col-xs-1 search-space\"></div>\n    <div class=\"col-xs-8 search-info\">\n      <div class=\"row\"><div class=\"col-xs-12 search-title\" id=\"search-title-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.cacheId : stack1), depth0))
    + "\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "</div></div>\n      <div class=\"row\"><div class=\"col-xs-12 search-link\"><a id=\"search-link-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.cacheId : stack1), depth0))
    + "\" href=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.link : stack1), depth0))
    + "\" target=\"_blank\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.link : stack1), depth0))
    + "</a></div></div>\n      <div class=\"row\"><div class=\"col-xs-12 search-snippet\" id=\"search-snippet-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.cacheId : stack1), depth0))
    + "\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.snippet : stack1), depth0))
    + "</div></div>\n    </div>\n  </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.results : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div class=\"row google-row\">\n    <div class=\"col-xs-3 search-image\" data-id=\"image-"
    ...
    + "\"></div>\n    <div class=\"col-xs-1 search-space\"></div>\n    <div class=\"col-xs-8 search-info\">\n      <div class=\"row\"><div class=\"col-xs-12 search-title spotify-title\" id=\"search-title-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">"
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" href=\""
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.external_urls : stack1)) != null ? stack1.spotify : stack1), depth0))
    + "\" target=\"_blank\">"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.external_urls : stack1)) != null ? stack1.spotify : stack1), depth0))
    + "</a></div></div>\n      <div class=\"row\"><div class=\"col-xs-12 search-snippet spotify-tracks\" id=\"search-snippet-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Total Tracks: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.tracks : stack1)) != null ? stack1.total : stack1), depth0))
    + "</div></div>\n    </div>\n  </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
...
var bootstrapPhoneHelper = function bootstrapPhoneHelper() {
  +function ($) {
...
module.exports = {
  bootstrapPhoneHelper: bootstrapPhoneHelper
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
